...
const { getByTestId, queryByTestId, queryAllByTestId } = require('@testing-library/dom');
...
describe('Test renderStatsCard', () => {
	...
	it('should hide individual stats', () => {
		...
		expect(document.body.getElementsByTagName('svg')[0].getAttribute('height')).toBe('120'); // height should be 120 because we clamped it.
	...
	it('should render default colors properly', () => {
		...
		expect(statClassStyles.fill).toBe('#000c');
	...
	it('should auto resize if hide_rank is true', () => {
		...
		expect(document.body.getElementsByTagName('svg')[0].getAttribute('width')).toBe('350');
	});
