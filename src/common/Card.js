...
class Card {
	constructor({ width = 100, height = 100, colors = {}, customTitle, defaultTitle = '', titlePrefixIcon }) {
		this.width = width;
		this.height = height;
	...
	render(body) {
      ...
      >
        ...
        <g
          ...
          transform="translate(0, ${this.hideTitle ? this.paddingX : this.paddingY + this.paddingYContent})"
        >
          ${body}
        </g>
      </svg>
